...
RSpec.describe ETL::Feedex do
  ...
  context 'When the base_path matches the feedex path' do
    ...
    it 'does not update metrics for other days' do
      fact1 = create :facts_metric, dimensions_item: item1, dimensions_date: dimensions_date, number_of_issues: 1
      day_before = date - 1
    ...
    it 'does not update metrics for other items' do
      ...
      fact = create :facts_metric, dimensions_item: item, dimensions_date: dimensions_date, number_of_issues: 9
