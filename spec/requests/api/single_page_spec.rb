...
RSpec.describe "/single_page", type: :request do
  ...
  let!(:item) do
    create :edition,
           ...
           first_published_at: Time.zone.parse("2018-07-17 10:35:59").iso8601,
           public_updated_at: Time.zone.parse("2018-07-17 10:35:57").iso8601,
    ...
    it "returns the metadata" do
      ...
      expected = {
        "metadata" => {
          ...
          "document_type" => "guide",
          "publishing_app" => "whitehall",
          "first_published_at" => "2018-07-17T10:35:59.000+01:00",
          "public_updated_at" => "2018-07-17T10:35:57.000+01:00",
          "primary_organisation_title" => "The ministry",
          "withdrawn" => false,
          "historical" => false,
