class AddIndexesViewAggregationsSearchLastTwelveMonths < ActiveRecord::Migration[5.2]
  def up
    ...
    add_index :aggregations_search_last_twelve_months, %i[organisation_id upviews], name: :search_last_twelve_months_gin_base_path_organisation_id
    add_index :aggregations_search_last_twelve_months, %i[document_type upviews], name: :search_last_twelve_months_gin_base_path_document_type
  end
